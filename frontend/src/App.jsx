...
import ManageBhaktnivasAvailability from './pages/provider/ManageBhaktnivasAvailability';
import ProviderBookings from './pages/provider/ProviderBookings';
import MyTemples from './pages/provider/MyTemples';
import CreateTemple from './pages/provider/CreateTemple';
import ManageDarshan from './pages/provider/ManageDarshan';
        ...
        <div className="d-flex flex-column min-vh-100">
            ...
            <main className="flex-grow-1">
                <Routes>
                    ...
                    />
                    <Route
                        path="/provider/listings/edit/:id"
                        element={
                            <ProtectedRoute roles={['ServiceProvider']}>
                                <CreateListing />
                            </ProtectedRoute>
                    ...
                    />
                    <Route
                        path="/provider/listings/:id/availability"
                        element={
                            <ProtectedRoute roles={['ServiceProvider']}>
                                <ManageBhaktnivasAvailability />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                    ...
                    <Route path="/provider/temples/:templeId/darshan" element={
                        <ProtectedRoute roles={['ServiceProvider']}>
                            <ManageDarshan />
                        </ProtectedRoute>
                    } />
